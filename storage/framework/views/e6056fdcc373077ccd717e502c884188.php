...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a href="<?php echo e(url('/individui/create')); ?>" class="btn btn-success btn-sm ml-2">
...
<tbody id="table-body">
        ...
        <div class="text-center text-muted py-5">
            ...
            <a href="<?php echo e(url('/individui/create')); ?>" class="btn btn-success">Crea il primo individuo</a>
        </div>
        <?php endif; ?>
    </div>
    <?php if($individui->count() > 0): ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="row" id="colonne-checkboxes">
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input col-visibile" id="col-vis-<?php echo e($col['key']); ?>" value="<?php echo e($col['key']); ?>" checked>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input col-toggle" id="col-toggle-<?php echo e($col['key']); ?>" value="<?php echo e($col['key']); ?>" checked onchange="toggleColumn('<?php echo e($col['key']); ?>', this.checked)">
...
let columnVisibility = <?php echo json_encode(array_column($tableColumns, 'key')); ?>;
